...
![数据类型和判断规则示例](DA2x.assets/sorting_examples.png)
...
=== "<1>"
    ![选择排序步骤](DA2x.assets/selection_sort_step1.png)

=== "<2>"
    ![selection_sort_step2](DA2x.assets/selection_sort_step2.png)

=== "<3>"
    ![selection_sort_step3](DA2x.assets/selection_sort_step3.png)

=== "<4>"
    ![selection_sort_step4](DA2x.assets/selection_sort_step4.png)

=== "<5>"
    ![selection_sort_step5](DA2x.assets/selection_sort_step5.png)

=== "<6>"
    ![selection_sort_step6](DA2x.assets/selection_sort_step6.png)

=== "<7>"
    ![selection_sort_step7](DA2x.assets/selection_sort_step7.png)

=== "<8>"
    ![selection_sort_step8](DA2x.assets/selection_sort_step8.png)

=== "<9>"
    ![selection_sort_step9](DA2x.assets/selection_sort_step9.png)

=== "<10>"
    ![selection_sort_step10](DA2x.assets/selection_sort_step10.png)

=== "<11>"
    ![selection_sort_step11](DA2x.assets/selection_sort_step11.png)
...
![选择排序非稳定示例](DA2x.assets/selection_sort_instability.png)
...
=== "<1>"
    ![利用元素交换操作模拟冒泡](DA2x.assets/bubble_operation_step1.png)

=== "<2>"
    ![bubble_operation_step2](DA2x.assets/bubble_operation_step2.png)

=== "<3>"
    ![bubble_operation_step3](DA2x.assets/bubble_operation_step3.png)

=== "<4>"
    ![bubble_operation_step4](DA2x.assets/bubble_operation_step4.png)

=== "<5>"
    ![bubble_operation_step5](DA2x.assets/bubble_operation_step5.png)

=== "<6>"
    ![bubble_operation_step6](DA2x.assets/bubble_operation_step6.png)

=== "<7>"
    ![bubble_operation_step7](DA2x.assets/bubble_operation_step7.png)
...
![冒泡排序流程](DA2x.assets/bubble_sort_overview.png)
...
![单次插入操作](DA2x.assets/insertion_operation.png)
...
![插入排序流程](DA2x.assets/insertion_sort_overview.png)
...
=== "<1>"
    ![哨兵划分步骤](DA2x.assets/pivot_division_step1.png)

=== "<2>"
    ![pivot_division_step2](DA2x.assets/pivot_division_step2.png)

=== "<3>"
    ![pivot_division_step3](DA2x.assets/pivot_division_step3.png)

=== "<4>"
    ![pivot_division_step4](DA2x.assets/pivot_division_step4.png)

=== "<5>"
    ![pivot_division_step5](DA2x.assets/pivot_division_step5.png)

=== "<6>"
    ![pivot_division_step6](DA2x.assets/pivot_division_step6.png)

=== "<7>"
    ![pivot_division_step7](DA2x.assets/pivot_division_step7.png)

=== "<8>"
    ![pivot_division_step8](DA2x.assets/pivot_division_step8.png)

=== "<9>"
    ![pivot_division_step9](DA2x.assets/pivot_division_step9.png)
...
![快速排序流程](DA2x.assets/quick_sort_overview.png)
...
![归并排序的划分与合并阶段](DA2x.assets/merge_sort_overview.png)
...
=== "<1>"
    ![归并排序步骤](DA2x.assets/merge_sort_step1.png)

=== "<2>"
    ![merge_sort_step2](DA2x.assets/merge_sort_step2.png)

=== "<3>"
    ![merge_sort_step3](DA2x.assets/merge_sort_step3.png)

=== "<4>"
    ![merge_sort_step4](DA2x.assets/merge_sort_step4.png)

=== "<5>"
    ![merge_sort_step5](DA2x.assets/merge_sort_step5.png)

=== "<6>"
    ![merge_sort_step6](DA2x.assets/merge_sort_step6.png)

=== "<7>"
    ![merge_sort_step7](DA2x.assets/merge_sort_step7.png)

=== "<8>"
    ![merge_sort_step8](DA2x.assets/merge_sort_step8.png)

=== "<9>"
    ![merge_sort_step9](DA2x.assets/merge_sort_step9.png)

=== "<10>"
    ![merge_sort_step10](DA2x.assets/merge_sort_step10.png)
...
![桶排序算法流程](DA2x.assets/bucket_sort_overview.png)
...
![递归划分桶](DA2x.assets/scatter_in_buckets_recursively.png)

如果我们提前知道商品价格的概率分布，**则可以根据数据概率分布设置每个桶的价格分界线**。值得注意的是，数据分布并不一定需要特意统计，也可以根据数据特点采用某种概率模型进行近似。

如下图所示，我们假设商品价格服从正态分布，这样就可以合理地设定价格区间，从而将商品平均分配到各个桶中。

![根据概率分布划分桶](DA2x.assets/scatter_in_buckets_distribution.png)
...
![计数排序流程](DA2x.assets/counting_sort_overview.png)
...
=== "<1>"
    ![计数排序步骤](DA2x.assets/counting_sort_step1.png)

=== "<2>"
    ![counting_sort_step2](DA2x.assets/counting_sort_step2.png)

=== "<3>"
    ![counting_sort_step3](DA2x.assets/counting_sort_step3.png)

=== "<4>"
    ![counting_sort_step4](DA2x.assets/counting_sort_step4.png)

=== "<5>"
    ![counting_sort_step5](DA2x.assets/counting_sort_step5.png)

=== "<6>"
    ![counting_sort_step6](DA2x.assets/counting_sort_step6.png)

=== "<7>"
    ![counting_sort_step7](DA2x.assets/counting_sort_step7.png)

=== "<8>"
    ![counting_sort_step8](DA2x.assets/counting_sort_step8.png)
...
![基数排序算法流程](DA2x.assets/radix_sort_overview.png)
...
![排序算法对比](DA2x.assets/sorting_algorithms_comparison.png)
