...
![图的广度优先遍历](DA7x.assets/graph_bfs.png)
...
=== "<1>"
    ![图的广度优先遍历步骤](DA7x.assets/graph_bfs_step1.png)

=== "<2>"
    ![graph_bfs_step2](DA7x.assets/graph_bfs_step2.png)

=== "<3>"
    ![graph_bfs_step3](DA7x.assets/graph_bfs_step3.png)

=== "<4>"
    ![graph_bfs_step4](DA7x.assets/graph_bfs_step4.png)

=== "<5>"
    ![graph_bfs_step5](DA7x.assets/graph_bfs_step5.png)

=== "<6>"
    ![graph_bfs_step6](DA7x.assets/graph_bfs_step6.png)

=== "<7>"
    ![graph_bfs_step7](DA7x.assets/graph_bfs_step7.png)

=== "<8>"
    ![graph_bfs_step8](DA7x.assets/graph_bfs_step8.png)

=== "<9>"
    ![graph_bfs_step9](DA7x.assets/graph_bfs_step9.png)

=== "<10>"
    ![graph_bfs_step10](DA7x.assets/graph_bfs_step10.png)

=== "<11>"
    ![graph_bfs_step11](DA7x.assets/graph_bfs_step11.png)
...
![图的深度优先遍历](DA7x.assets/graph_dfs.png)
...
=== "<1>"
    ![图的深度优先遍历步骤](DA7x.assets/graph_dfs_step1.png)

=== "<2>"
    ![graph_dfs_step2](DA7x.assets/graph_dfs_step2.png)

=== "<3>"
    ![graph_dfs_step3](DA7x.assets/graph_dfs_step3.png)

=== "<4>"
    ![graph_dfs_step4](DA7x.assets/graph_dfs_step4.png)

=== "<5>"
    ![graph_dfs_step5](DA7x.assets/graph_dfs_step5.png)

=== "<6>"
    ![graph_dfs_step6](DA7x.assets/graph_dfs_step6.png)

=== "<7>"
    ![graph_dfs_step7](DA7x.assets/graph_dfs_step7.png)

=== "<8>"
    ![graph_dfs_step8](DA7x.assets/graph_dfs_step8.png)

=== "<9>"
    ![graph_dfs_step9](DA7x.assets/graph_dfs_step9.png)

=== "<10>"
    ![graph_dfs_step10](DA7x.assets/graph_dfs_step10.png)

=== "<11>"
    ![graph_dfs_step11](DA7x.assets/graph_dfs_step11.png)
