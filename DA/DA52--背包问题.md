...
![0-1 背包的示例数据](DA5x.assets/knapsack_example.png)
...
![0-1 背包问题的暴力搜索递归树](DA5x.assets/knapsack_dfs.png)
...
![0-1 背包问题的记忆化搜索递归树](DA5x.assets/knapsack_dfs_mem.png)
...
=== "<1>"
    ![0-1 背包问题的动态规划过程](DA5x.assets/knapsack_dp_step1.png)

=== "<2>"
    ![knapsack_dp_step2](DA5x.assets/knapsack_dp_step2.png)

=== "<3>"
    ![knapsack_dp_step3](DA5x.assets/knapsack_dp_step3.png)

=== "<4>"
    ![knapsack_dp_step4](DA5x.assets/knapsack_dp_step4.png)

=== "<5>"
    ![knapsack_dp_step5](DA5x.assets/knapsack_dp_step5.png)

=== "<6>"
    ![knapsack_dp_step6](DA5x.assets/knapsack_dp_step6.png)

=== "<7>"
    ![knapsack_dp_step7](DA5x.assets/knapsack_dp_step7.png)

=== "<8>"
    ![knapsack_dp_step8](DA5x.assets/knapsack_dp_step8.png)

=== "<9>"
    ![knapsack_dp_step9](DA5x.assets/knapsack_dp_step9.png)

=== "<10>"
    ![knapsack_dp_step10](DA5x.assets/knapsack_dp_step10.png)

=== "<11>"
    ![knapsack_dp_step11](DA5x.assets/knapsack_dp_step11.png)

=== "<12>"
    ![knapsack_dp_step12](DA5x.assets/knapsack_dp_step12.png)

=== "<13>"
    ![knapsack_dp_step13](DA5x.assets/knapsack_dp_step13.png)

=== "<14>"
    ![knapsack_dp_step14](DA5x.assets/knapsack_dp_step14.png)
...
=== "<1>"
    ![0-1 背包的空间优化后的动态规划过程](DA5x.assets/knapsack_dp_comp_step1.png)

=== "<2>"
    ![knapsack_dp_comp_step2](DA5x.assets/knapsack_dp_comp_step2.png)

=== "<3>"
    ![knapsack_dp_comp_step3](DA5x.assets/knapsack_dp_comp_step3.png)

=== "<4>"
    ![knapsack_dp_comp_step4](DA5x.assets/knapsack_dp_comp_step4.png)

=== "<5>"
    ![knapsack_dp_comp_step5](DA5x.assets/knapsack_dp_comp_step5.png)

=== "<6>"
    ![knapsack_dp_comp_step6](DA5x.assets/knapsack_dp_comp_step6.png)
...
![完全背包问题的示例数据](DA5x.assets/unbounded_knapsack_example.png)
...
=== "<1>"
    ![完全背包问题在空间优化后的动态规划过程](DA5x.assets/unbounded_knapsack_dp_comp_step1.png)

=== "<2>"
    ![unbounded_knapsack_dp_comp_step2](DA5x.assets/unbounded_knapsack_dp_comp_step2.png)

=== "<3>"
    ![unbounded_knapsack_dp_comp_step3](DA5x.assets/unbounded_knapsack_dp_comp_step3.png)

=== "<4>"
    ![unbounded_knapsack_dp_comp_step4](DA5x.assets/unbounded_knapsack_dp_comp_step4.png)

=== "<5>"
    ![unbounded_knapsack_dp_comp_step5](DA5x.assets/unbounded_knapsack_dp_comp_step5.png)

=== "<6>"
    ![unbounded_knapsack_dp_comp_step6](DA5x.assets/unbounded_knapsack_dp_comp_step6.png)
...
![零钱兑换问题的示例数据](DA5x.assets/coin_change_example.png)
...
=== "<1>"
    ![零钱兑换问题的动态规划过程](DA5x.assets/coin_change_dp_step1.png)

=== "<2>"
    ![coin_change_dp_step2](DA5x.assets/coin_change_dp_step2.png)

=== "<3>"
    ![coin_change_dp_step3](DA5x.assets/coin_change_dp_step3.png)

=== "<4>"
    ![coin_change_dp_step4](DA5x.assets/coin_change_dp_step4.png)

=== "<5>"
    ![coin_change_dp_step5](DA5x.assets/coin_change_dp_step5.png)

=== "<6>"
    ![coin_change_dp_step6](DA5x.assets/coin_change_dp_step6.png)

=== "<7>"
    ![coin_change_dp_step7](DA5x.assets/coin_change_dp_step7.png)

=== "<8>"
    ![coin_change_dp_step8](DA5x.assets/coin_change_dp_step8.png)

=== "<9>"
    ![coin_change_dp_step9](DA5x.assets/coin_change_dp_step9.png)

=== "<10>"
    ![coin_change_dp_step10](DA5x.assets/coin_change_dp_step10.png)

=== "<11>"
    ![coin_change_dp_step11](DA5x.assets/coin_change_dp_step11.png)

=== "<12>"
    ![coin_change_dp_step12](DA5x.assets/coin_change_dp_step12.png)

=== "<13>"
    ![coin_change_dp_step13](DA5x.assets/coin_change_dp_step13.png)

=== "<14>"
    ![coin_change_dp_step14](DA5x.assets/coin_change_dp_step14.png)

=== "<15>"
    ![coin_change_dp_step15](DA5x.assets/coin_change_dp_step15.png)
...
![零钱兑换问题 II 的示例数据](DA5x.assets/coin_change_ii_example.png)
