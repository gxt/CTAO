...
![完美二叉树的数组表示](DA6x.assets/array_representation_binary_tree.png)
...
![层序遍历序列对应多种二叉树可能性](DA6x.assets/array_representation_without_empty.png)
...
![任意类型二叉树的数组表示](DA6x.assets/array_representation_with_empty.png)

值得说明的是，**完全二叉树非常适合使用数组来表示**。回顾完全二叉树的定义，`None` 只出现在最底层且靠右的位置，**因此所有 `None` 一定出现在层序遍历序列的末尾**。

这意味着使用数组表示完全二叉树时，可以省略存储所有 `None` ，非常方便。下图给出了一个例子。

![完全二叉树的数组表示](DA6x.assets/array_representation_complete_binary_tree.png)
...
![构建二叉树的示例数据](DA6x.assets/build_tree_example.png)
...
![在前序遍历和中序遍历中划分子树](DA6x.assets/build_tree_preorder_inorder_division.png)
...
![根节点和左右子树的索引区间表示](DA6x.assets/build_tree_division_pointers.png)
...
=== "<1>"
    ![构建二叉树的递归过程](DA6x.assets/built_tree_step1.png)

=== "<2>"
    ![built_tree_step2](DA6x.assets/built_tree_step2.png)

=== "<3>"
    ![built_tree_step3](DA6x.assets/built_tree_step3.png)

=== "<4>"
    ![built_tree_step4](DA6x.assets/built_tree_step4.png)

=== "<5>"
    ![built_tree_step5](DA6x.assets/built_tree_step5.png)

=== "<6>"
    ![built_tree_step6](DA6x.assets/built_tree_step6.png)

=== "<7>"
    ![built_tree_step7](DA6x.assets/built_tree_step7.png)

=== "<8>"
    ![built_tree_step8](DA6x.assets/built_tree_step8.png)

=== "<9>"
    ![built_tree_step9](DA6x.assets/built_tree_step9.png)

每个递归函数内的前序遍历 `preorder` 和中序遍历 `inorder` 的划分结果如下图所示。

![每个递归函数中的划分结果](DA6x.assets/built_tree_overall.png)
